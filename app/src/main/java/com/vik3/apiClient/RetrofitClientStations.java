...
public class RetrofitClientStations {

    private static RetrofitClientStations mInstance;
    private Retrofit retrofit;

    private RetrofitClientStations() {
...
//                .client(client)
    ...
    public static synchronized RetrofitClientStations getInstance() {
        if (mInstance == null) {
            mInstance = new RetrofitClientStations();
        }
        return mInstance;
    }
